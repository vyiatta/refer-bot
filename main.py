...
BOT_TOKEN = "7459779382:AAEtxsHtpMToFoTdjRokWj46-qijA8LbxU0"
PAYMENT_CHANNEL = "@referteest"
OWNER_ID = 672551346
CHANNELS = ["@referteest"]
Daily_bonus = 1
Mini_Withdraw = 0.5
   ...
   try:
    ...
    if msg == '/start':
        ...
        markups.add(telebot.types.InlineKeyboardButton(
            text='🤼‍♂️ Joined', callback_data='check'))
        msg_start = "*🍔 To Use This Bot You Need To Join This Channel - ➡️ @referteest"
        bot.send_message(user, msg_start,
